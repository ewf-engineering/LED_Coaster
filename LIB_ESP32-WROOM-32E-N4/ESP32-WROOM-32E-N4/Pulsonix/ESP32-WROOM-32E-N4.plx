...
(library Library_1
	...
	(compDef "ESP32-WROOM-32E-N4" (originalName "ESP32-WROOM-32E-N4") (compHeader (numPins 47) (numParts 1) (refDesPrefix IC)
		...
		(compPin "19" (pinName "NC_3") (partNum 1) (symPinNum 19) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(compPin "22" (pinName "NC_6") (partNum 1) (symPinNum 22) (gateEq 0) (pinEq 0) (pinType Unknown))
		...
		(attr "<Hyperlink>" "https://www.espressif.com/sites/default/files/documentation/esp32-wroom-32e_esp32-wroom-32ue_datasheet_en.pdf")
		(attr "<Component Height>" "3.25")
		(attr "<STEP Filename>" "ESP32-WROOM-32E-N4.stp")
		(attr "<STEP Offsets>" "X=-0.12;Y=0;Z=0")
